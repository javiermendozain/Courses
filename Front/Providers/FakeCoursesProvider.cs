...
{
    // Fake because it provides sample data as a database
    public class FakeCoursesProvider : ICoursesProvider
    {
        ...
        {
            // Get and increase the major id of the courses list
            course.Id = repo.Max(c => c.Id) + 1;
            
            // Add new course at the list
            repo.Add(course);
        ...
        {
            // Return the courses Collections as List
        ...
        {
            // Return the courses Collections as List, filtered by Name
